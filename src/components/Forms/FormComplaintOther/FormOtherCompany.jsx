...
function FormOtherCompany() {
    ...
    const formTitles = ['Ingrese el CUIT de la Empresa Asegurada y la Fecha y Hora del Siniestro', 'Indique Lugar del Siniestro y descripción de los hechos', 'Resumen del Siniestro a Denunciar'];
