...
function FormQuestion1({formData, setFormData, errors, setErrors, expressions}) {
    ...
    return (
        <div className='formQuestions1'>
            ...
            <div className="form-group-1 form-group-3">
                <label htmlFor="dnc_sex">Sexo</label>
                <select
                    name="dnc_sex"
                    id="dnc_sex"
                    value={formData.driver_not_client.dnc_sex}
                    onChange={(e) => setFormData({ ...formData, driver_not_client : {
                        ...formData.driver_not_client,
                        dnc_sex: e.target.value
                        } })}
                > 
                    <option value=""></option>
                ...
                {errors.dnc_sex ? <span className="msg-error">{errors.dnc_sex}</span> : ""}
            </div>
            ...
            <div className="form-group-1 form-group-2">
                <label htmlFor="dnc_occupation">Ocupación</label>
                <select
                    name="dnc_occupation"
                    id="dnc_occupation"
                    value={formData.driver_not_client.dnc_occupation}
                    onChange={(e) => setFormData({ ...formData, driver_not_client : {
                        ...formData.driver_not_client,
                        dnc_occupation: e.target.value
                        } })}
                > 
                    <option value=""></option>
                    <option value="Plomero">PLOMERO</option>
                    <option value="Gacista">GASISTA</option>
                    <option value="Músico">MUSICO</option>
                </select>
                {errors.dnc_occupation ? <span className="msg-error">{errors.dnc_occupation}</span> : ""}
            </div>
