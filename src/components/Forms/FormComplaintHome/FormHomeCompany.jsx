...
function FormHomeCompany() {
    ...
    const formTitles = ['Ingrese el CUIT de la Empresa Asegurada y la Fecha y Hora del Siniestro', 'Contanos que te ocurrió', 'Descripción de los hechos', 'Resumen del Siniestro a Denunciar'];
    ...
    const [datosFormu, setDatosFormu] = useState({
        ...
        consequence: {
            ...
            pc_notebook_celular_rotura: false,
            pc_notebook_celular_robo: false,
            electrodomesticos_robo: false,
            electrodomesticos_rotura: false,
    ...
    formData.append('notebook_rotura', datosFormu.consequence.pc_notebook_celular_rotura)
    formData.append('notebook_robo', datosFormu.consequence.pc_notebook_celular_robo)
    formData.append('denuncia_notebook', datosFormu.police_complaint_notebook)
    formData.append('electrodomesticos_rotura', datosFormu.consequence.electrodomesticos_rotura)
    formData.append('electrodomesticos_robo', datosFormu.consequence.electrodomesticos_robo)
    formData.append('denuncia_electro', datosFormu.police_complaint_electro)
    formData.append('bicicletas_robo', datosFormu.consequence.bicicletas_robo)
    formData.append('denuncia_bicicleta', datosFormu.police_complaint_bicicleta)
